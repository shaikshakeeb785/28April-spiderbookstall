...
<%--<center>
        <c:forEach var="object" items="${restObject}">
                  <div class="container"  style="background-image: url('https://wallpapercave.com/wp/g0c4dxk.jpg');width: 200px">
                        &lt;%&ndash;heare i am passing bookid by using queryString and accessing in controller by using @RequestParam&ndash;%&gt;
                     <p>BOOK_ID:</p><a href="getBookById?bookId=${object.bookId}">${object.bookId}</a><br>
                        &lt;%&ndash;hear i am passing bookid by using queryString and accessing in controller by using @RequestParam&ndash;%&gt;
                     <P>BookName:</P><a href="getBookById?bookId=${object.bookId}">${object.bookName}</a><br>
                        ...
                        &lt;%&ndash;hear iam passing book id by buy uri directly and accessing in controller by using @PathVareable&ndash;%&gt;
                    <c:url value="/buyBook/${object.bookId}" var="Buy"/>
                    <P>BUY BOOK BUTTON:</P><a href="${Buy}">BUY</a><br>
                    <hr>
                  </div>
        </c:forEach>
</center>--%>
